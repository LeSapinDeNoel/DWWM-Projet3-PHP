<article>
  <a href="{site_url('critic/critic_edit')}?art={$objCritic->critic_id}" class="text-center text-dark">
    ...
    <h2 class="text-center"><a href="#" class="DeleteCritic mx-auto d-block text-center" title="Supprimer"><i class="fas fa-minus-square"></i><br/></a>{$objCritic->critic_title}</h2>
