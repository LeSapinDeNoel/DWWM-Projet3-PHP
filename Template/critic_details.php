  ...
  <section class="">
    ...
    <article class="">
        ...
        <ul class="d-flex justify-content-center text-secondary" style="list-style-type:none">
          <li class="m-3">Nom du créateur</li>
          <li class="m-3">Date de création</li>
